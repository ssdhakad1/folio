                ...
                <tr>
                  <td style="padding:32px 32px 24px;border-bottom:1px solid #2a2d3e;">
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="background:#6366f1;border-radius:8px;width:32px;height:32px;text-align:center;vertical-align:middle;font-size:18px;line-height:32px;padding:0;">📖</td>
